...
import shutil
extract_from="folder"
path_to_input_images="tmpsquarize/Imagesfortrainingdark/"
...
for image in tqdm(files):
  ...
  if w>h:
    ...
    cv2.imwrite("tmpsquarize/padded_imgs-masks/"+str(c)+"_mask.png",newim)
  else:
  ...
  c=c+1
  Exception("hi")
print("masks done! starting inpainting...")